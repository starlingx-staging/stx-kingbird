...
class DBAPISubcloudTest(base.DCManagerTestCase):
    ...
    @staticmethod
    def create_subcloud(ctxt, **kwargs):
        values = {
            'name': "subcloud1",
    ...
    def test_create_subcloud(self):
        name = 'testname'
        subcloud = self.create_subcloud(self.ctx, name=name)
    ...
    def test_create_multiple_subclouds(self):
        ...
        name2 = 'testname2'
        name3 = 'testname3'
        subcloud = self.create_subcloud(self.ctx, name=name1)
        self.assertIsNotNone(subcloud)

        subcloud2 = self.create_subcloud(self.ctx, name=name2,
                                         management_start_ip="2.3.4.6",
                                         management_end_ip="2.3.4.7")
        self.assertIsNotNone(subcloud2)

        subcloud3 = self.create_subcloud(self.ctx, name=name3,
    ...
    def test_strategy_step_get_all(self):
        subcloud1 = self.create_subcloud(self.ctx, name='subcloud one')
        self.assertIsNotNone(subcloud1)
        subcloud2 = self.create_subcloud(self.ctx, name='subcloud two')
        self.assertIsNotNone(subcloud2)
        subcloud3 = self.create_subcloud(self.ctx, name='subcloud three')
        self.assertIsNotNone(subcloud3)
